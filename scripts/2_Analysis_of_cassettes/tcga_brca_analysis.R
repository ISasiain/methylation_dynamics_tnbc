...
# Cassette 1
cpgs_1 <- names(distal_7$colors)[distal_7$colors == 1]
cpgs_1 <- cpgs_1[cpgs_1 %in% rownames(tcga$betaAdj)]

cpgs_2 <- names(distal_7$colors)[distal_7$colors == 2]
cpgs_2 <- cpgs_2[cpgs_2 %in% rownames(tcga$betaAdj)]

cpgs_3 <- names(distal_7$colors)[distal_7$colors == 3]
cpgs_3 <- cpgs_3[cpgs_3 %in% rownames(tcga$betaAdj)]

cpgs_4 <- names(distal_7$colors)[distal_7$colors == 4]
cpgs_4 <- cpgs_4[cpgs_4 %in% rownames(tcga$betaAdj)]

cpgs_5 <- names(distal_7$colors)[distal_7$colors == 5]
cpgs_5 <- cpgs_5[cpgs_5 %in% rownames(tcga$betaAdj)]

cpgs_6 <- names(distal_7$colors)[distal_7$colors == 6]
cpgs_6 <- cpgs_6[cpgs_6 %in% rownames(tcga$betaAdj)]

cpgs_7 <- names(distal_7$colors)[distal_7$colors == 7]
