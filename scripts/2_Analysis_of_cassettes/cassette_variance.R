...
# Cassettes labels
proximal_7 <- readRDS("/Volumes/Data/Project_3/detected_cassettes/proximal/cassettes_beta_7.rds")$colors
promoter_7 <- readRDS("/Volumes/Data/Project_3/detected_cassettes/promoter/cassettes_beta_7.rds")$colors
distal_7 <- readRDS("/Volumes/Data/Project_3/detected_cassettes/distal/cassettes_beta_7.rds")$colors
...
# Merging labels
cpg_labels <- c(sapply(proximal_7, function(x) {paste0("proximal_", x)}),
                sapply(distal_7, function(x) {paste0("distal_", x)}),
                sapply(promoter_7, function(x) {paste0("promoter_", x)}))
...
combined_1 <- violin_plot / bar_plot +
