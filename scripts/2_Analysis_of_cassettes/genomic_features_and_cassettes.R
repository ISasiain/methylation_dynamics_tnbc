...
# Loading enhancer data (This file is already in hg38, so no need to adapt)
...
cpg_density_5000 <- readRDS("/Users/in2245sa/PhD/Projects/project_3/analysis/cpg_density/cpg_density_5000_bp.rds")
cpg_density_10000 <- readRDS("/Users/in2245sa/PhD/Projects/project_3/analysis/cpg_density/cpg_density_10000_bp.rds")
...
# DISTAL 1
cpgs_1 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 1]
...
# DISTAL 2
cpgs_2 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 2]
...
# DISTAL 3
cpgs_3 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 3]
...
# DISTAL 4
cpgs_4 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 4]
...
# DISTAL 5
cpgs_5 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 5]
...
# DISTAL 6
cpgs_6 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 6]
...
# DISTAL 7
cpgs_7 <- names(dist_cassette_7$colors)[dist_cassette_7$colors == 7]
...
# Get CpGs to analyse
cpgs_for_density <- names(dist_cassette_7$colors)[dist_cassette_7$colors %in% c(7,6,5,4,3,2,1)]
...
density_of_interest$cassette <- dist_cassette_7$colors[density_of_interest$cpg_id]
...
tf_proportions <- rbind(
  "1" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 1],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 1]),
  "2" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 2],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 2]),
  "3" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 3],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 3]),
  "4" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 4],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 4]),
  "5" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 5],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 5]),
  "6" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 6],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 6]),
  "7" = colSums(tfMat[names(dist_cassette_7$colors)[dist_cassette_7$colors == 7],], na.rm = T) / length(names(dist_cassette_7$colors)[dist_cassette_7$colors == 7])
