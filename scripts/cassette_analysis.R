...
for (file in all_files) {
  ...
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/all_cassettes/diff_betas/heatmap_beta_", beta, ".png"), width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in all_files) {
  ...
  # Save the heatmap to a file
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/all_cassettes/diff_betas/heatmap_beta_", beta, "_unadjusted_from_unadjusted.png"), width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in distal_files) {
  ...
  # Save the heatmap to a file 
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/distal_cassettes/diff_betas/heatmap_beta_", beta, ".png"), , width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in distal_files) {
  ...
  # Save the heatmap to a file 
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/distal_cassettes/diff_betas/heatmap_beta_", beta, "_only_atac.png"), , width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in distal_files) {
  ...
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/distal_cassettes/diff_betas/heatmap_beta_", beta, "_VALIDATION.png"), , width = 4000, height = 2200, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in distal_files) {
  ...
  # Save the heatmap to a file with double size
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/distal_cassettes/diff_betas/heatmap_beta_", beta, "_only_atac_VALIDATION.png"), , width = 4000, height = 2200, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in promoter_files) {
  ...
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/promoter_cassettes/diff_betas/heatmap_beta_", beta, ".png"), , width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in promoter_files) {
  ...
  # Save the heatmap to a file with double size
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/promoter_cassettes/diff_betas/heatmap_beta_", beta, "_VALIDATION.png"),
...
for (file in proximal_files) {
  ...
  # Save the heatmap to a file
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/proximal_cassettes/diff_betas/heatmap_beta_", beta, ".png") , width = 4000, height = 2800, res = 600)
  draw(heatmap)
  dev.off()
}
...
for (file in proximal_files) {
  ...
  # Save the heatmap to a file with double size
  png(paste0("/Users/in2245sa/PhD/Projects/project_3/analysis/proximal_cassettes/diff_betas/heatmap_beta_", beta, "_VALIDATION.png"),
      width = 4000, height = 2200, res = 600)
  draw(heatmap)
  dev.off()
}
